...
|---|---|---|---|---|---|---|---|
| [bootstrap](https://github.com/twbs/bootstrap) | 174,424 | `d35950e` | 99 files / 344 KB | 618 ms | 80 ms | **7.7×** | byte-identical |
| [bulma](https://github.com/jgthms/bulma) | 50,072 | `741da22` | 182 files / 1078 KB | 1353 ms | 233 ms | **5.8×** | comments/selector-order only |
| [govuk-frontend](https://github.com/alphagov/govuk-frontend) | 1,420 | `cfd2224` | 304 files / 276 KB | 421 ms | 42 ms | **10.1×** | byte-identical |
...
| [quasar](https://github.com/quasarframework/quasar) | 27,189 | `4202048` | 92 files / 223 KB | 517 ms | 172 ms | **3.0×** | byte-identical |
| [mastodon](https://github.com/mastodon/mastodon) | 50,088 | `163f96c` | 31 files / 343 KB | 388 ms | 18 ms | **21.3×** | byte-identical |
